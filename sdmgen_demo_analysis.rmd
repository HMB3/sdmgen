...
The species list is then supplied to a series of functions to calculate enviromnetal ranges and habitat 
...
here is a prepared one https://drive.google.com/open?id=1tb0-r-0SMI5SytFcWNGojyvuA7QHX8Gb 
...
## https://drive.google.com/open?id=1tb0-r-0SMI5SytFcWNGojyvuA7QHX8Gb 
...
resolution (1km*1km) and projection (mollweide) as the analysis data. This step takes ages...https://drive.google.com/open?id=1oY5ZWCV3eoKAWShCaApgLvV6Mb9G0HFQ 

\

It also uses another template raster of 1km*1km, this time in Mollweide projection
https://drive.google.com/open?id=1urJuHfkVtUz6fBLcbvgUhcO_G-d51MZL
...
## Read in the template raster at 1km*1km resolution
...
Given a candidate set of predictor variables, the function identifies 
a subset of variables that meets specified multicollinearity criteria. Subsequently, backward stepwise variable selection is 
used to iteratively drop the variable that contributes least to the model, until the 
contribution of each variable meets a specified minimum, or until a predetermined minimum 
number of predictors remains
