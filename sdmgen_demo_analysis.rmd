...
We can demonstrate the workflow using a sample of 10 species from the Stoten
publication above. 
...
## Use the first 10 plant species in the list
data("plant.spp")
...
It downloads the species to the specified folders, which must exist first, without returning anything.
