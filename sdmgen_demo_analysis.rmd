...
ALA.LAND = combine_ala_records(species_list      = analysis_spp,
                               ...
                               record_type       = "ALA",
                               keep_cols         = ALA_keep,
                               world_raster      = world.grids.current[[1]])
...
template.raster.1km.WGS84 = raster("./data/world_koppen/template_1km_WGS84.tif")
...
# template.raster.1km.WGS84[template.raster.1km.WGS84 > 0] <- 1
# template.raster.1km.WGS84[template.raster.1km.WGS84 < 0] <- 1
xres(template.raster.1km.WGS84);projection(template.raster.1km.WGS84)
...
extent (global), resolution (1km*1km) and projection (mollweide) as the analysis data. This step takes
ages...https://drive.google.com/open?id=1oY5ZWCV3eoKAWShCaApgLvV6Mb9G0HFQ 
...
# template.raster.1km.mol[template.raster.1km.mol > 0] <- 1
# template.raster.1km.mol[template.raster.1km.mol < 0] <- 1
