...
The backbone of the R workflow is a list of plant species that we supply. 
The analysis is designed to process data for one species at a time, allowing
species results to be updated as required. We can demonstrate the workflow 
using a sample of 10 species from the Stoten publication above. 
